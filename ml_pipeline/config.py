...
GROQ_MODEL_HEAVY = os.environ.get("GROQ_MODEL_HEAVY", "openai/gpt-oss-120b")
GROQ_MODEL_LIGHT = os.environ.get("GROQ_MODEL_LIGHT", "openai/gpt-oss-20b")
GROQ_MODEL_PRIMARY = os.environ.get("GROQ_MODEL_PRIMARY", GROQ_MODEL_LIGHT)
GROQ_MODEL_FAST = os.environ.get("GROQ_MODEL_FAST", GROQ_MODEL_HEAVY)
