        ...
        warnings = [
            {
                **i,
                ...
                "category": "CONFLICTING_EVIDENCE" if "CONFLICTING" in i.get("code", "") else (i.get("code") if i.get("code") == "STALE_EVIDENCE" else i.get("category")),
                "severity": "HIGH" if "CONFLICTING" in i.get("code", "") else i.get("severity"),
                "remediation": "Schedule supervised practical verification" if "CONFLICTING" in i.get("code", "") else i.get("remediation"),
            }
            for i in all_issues if i.get("severity") in ("WARNING", "HIGH") or "CONFLICTING" in i.get("code", "")
        ]
